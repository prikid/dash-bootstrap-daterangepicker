...
export ''_dashbootstrapdaterangepicker

"""
    ''_dashbootstrapdaterangepicker(;kwargs...)
...
"""
function ''_dashbootstrapdaterangepicker(; kwargs...)
        available_props = Symbol[:id, :className, :end_date, :initialSettings, :innerClassName, :start_date]
        wild_props = Symbol[]
        return Component("''_dashbootstrapdaterangepicker", "DashBootstrapDaterangepicker", "dash_bootstrap_daterangepicker", available_props, wild_props; kwargs...)
end
